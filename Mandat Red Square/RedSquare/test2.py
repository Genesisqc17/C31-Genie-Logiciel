...
class Vue():
    def __init__(self, parent, modele):
        ...
        self.canevasPetit.bind("<Button-1>", self.start_drag)
    ...
    def end_drag(self, event):
        ...
        self.toc = time.perf_counter() # end timer pour score
        print(f"time: {self.toc - self.tic:0.4f}") # print score
